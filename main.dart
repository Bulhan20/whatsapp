              ...
              children: [
                ListTile(
                  leading: CircleAvatar(
                    radius: 28,
                    backgroundImage:
                        AssetImage('assets/splash_ilustration.png'),
                  ),
                  title: Text(
                    'Eng Ahmed',
                    style: TextStyle(
                  ...
                  subtitle: Text(
                    'Nio intee xaafadaa joogaa irida iga fur',
                    maxLines: 1,
                ...
                ListTile(
                  ...
                  subtitle: Text(
                    'xuseen biyihii way dhamaadeen hore usoo gad kortoon',
                    maxLines: 1,
                    overflow: TextOverflow.ellipsis,
                  ),
                  trailing: Text(
                ...
                ListTile(
                  leading: CircleAvatar(
                    radius: 28,
                    backgroundImage:
                        AssetImage('assets/order_success_ilustration.png'),
                  ),
                  title: Text(
                    'CA201 JUST',
                    style: TextStyle(
              ...
              children: [
                ListTile(
                  leading: CircleAvatar(
                    radius: 28,
                    backgroundImage:
                        AssetImage('assets/1_h21_jYgCfD0emCz5x7H8cA.png'),
                  ),
                  title: Text(
                    'My Status',
                    style: TextStyle(
